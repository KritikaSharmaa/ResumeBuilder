    ...
    {/** Here is Ref*/}
        ...
        <div className="w-7/12 h-screen">
           ...
           {/** download pdf when you clicked on button by taking ref from above div*/}
            <Pdf targetRef={ref} filename="MY_Resume.pdf" scale={1.39} >
            {
            ({ toPdf }) => 
            <button className="p-2 border-none bg-LightBrown text-white text-center font-semibold rounded-md w-52" onClick={toPdf} >
